...
- If the user declines the runtime permission dialog, then manually enables permissions via the device Settings UI for you application, then manually disables them again, then you can request permissions again via the runtime permission dialog.
