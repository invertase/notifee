...
public class GetNotificationSettingsTest {
  ...
  @Test
  public void testNotificationSettingsCorrectResponse()
    ...
    device.wait(
        Until.hasObject(
            By.text(
                "{\"authorizationStatus\":0,\"ios\":{\"alert\":1,\"badge\":1,\"criticalAlert\":1,\"showPreviews\":1,\"sound\":1,\"carPlay\":1,\"lockScreen\":1,\"announcement\":1,\"notificationCenter\":1,\"inAppNotificationSettings\":1,\"authorizationStatus\":0}}")),
        TIMEOUT);
    ...
    Assert.assertTrue(
        device
            .findObject(
                new UiSelector()
                    .text(
                        "{\"authorizationStatus\":1,\"ios\":{\"alert\":1,\"badge\":1,\"criticalAlert\":1,\"showPreviews\":1,\"sound\":1,\"carPlay\":1,\"lockScreen\":1,\"announcement\":1,\"notificationCenter\":1,\"inAppNotificationSettings\":1,\"authorizationStatus\":1}}"))
            .exists());
    device.waitForIdle();
    device.findObject(new UiSelector().text("CANCEL")).click();
  }
