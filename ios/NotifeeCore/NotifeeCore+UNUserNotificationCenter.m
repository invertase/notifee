...
// The application can choose to have the notification presented as a sound, badge, alert and/or in
// the notification list. This decision should be based on whether the information in the
